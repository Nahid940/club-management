                    ...
                    <form id="payment_report_form">
                        <div class="row search_frm">
                            ...
                            <div class="col-md-2 col-sm-12">
                                <label for="date_from">Member Name/ID</label>
                                <input type="text" class="form-control" name="member" placeholder="Member Name/ID">
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <label for="date_from">Date From <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" value="{{ date('Y-m-d')}}" id="date_from" name="date_from" required/>
                                <span id="date_from_error" class="text-danger"></span>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <label for="date_to">Date To <span class="text-danger">*</span> </label>
                                <input type="date" class="form-control" value="{{ date('Y-m-d') }}" id="date_to" name="date_to" required/>
...
@stop
@section('script_link')
    <script src="{{asset('js/bill-report.js')}}"></script>
@stop
