                    ...
                    <form id="report_form">
                        <div class="row search_frm">
                            <div class="col-md-2 col-sm-12">
                                <label for="profession" class="lbl_passing_year">Select Profession</label>
                                ...
                                <span class="text-danger txt_profession"></span>
                            </div>
...
@stop
@section('script_link')
    <script src="{{asset('js/profession-report.js')}}"></script>
@stop
