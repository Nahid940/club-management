...
@section('content')
                    ...
                    <form id="report_form">
                        <div class="row search_frm">
                            <div class="col-md-2 col-sm-12">
                                <label for="from_month" class="lbl_passing_year">Due Duration Period</label>
                                <select name="month_duration" id="month_duration" class="form-control">
                            ...
                            <div class="col-2" style="margin-top: 19px;font-size: inherit">
                                <button type="button" class="btn btn-primary btn-xs" id="show-monthly-fee-report">View Report</button>
    ...
    <div class="report_div" style="width: 900px;height: 257mm;overflow-y: scroll; margin: auto;background-color: #fff">
...
@stop
@section('script_link')
    <script src="{{asset('js/duration-wise-due.js')}}"></script>
@stop
