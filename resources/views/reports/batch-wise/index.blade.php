                    ...
                    <form id="report_form">
                        <div class="row search_frm">
                            <div class="col-md-2 col-sm-12">
                                <label for="date_from" class="lbl_passing_year">Passing Year (Batch)</label>
                                <select name="passing_year" id="passing_year" class="form-control">
                                    <option value="">--Select--</option>
                                    <option value="0">--All--</option>
                                    @foreach($passing_years as $passing_year)
                                        <option value="{{$passing_year->passing_year}}">{{$passing_year->passing_year}}</option>
                                    @endforeach
                                </select>
                            </div>
...
@stop
@section('script_link')
    <script src="{{asset('js/batch-report.js')}}"></script>
@stop
