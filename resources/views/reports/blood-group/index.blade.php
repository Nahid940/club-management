                    ...
                    <form id="report_form">
                        <div class="row search_frm">
                            <div class="col-md-2 col-sm-12">
                                <label for="profession" class="lbl_passing_year">Select Blood Group</label>
                                ...
                                <span class="tst_blood_group text-danger"></span>
                            </div>
...
@stop
@section('script_link')
    <script src="{{asset('js/blood-group-report.js')}}"></script>
@stop
