        ...
        <div class="col-md-10 offset-md-1 col-sm-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><i class="fa fa-sticky-note" aria-hidden="true"></i> Update New Notice</h3>
                ...
                <form action="{{route('notice-update')}}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="{{$notice->title}}" name="title" placeholder="Title" required>
                            </div>
                            <div class="col-md-6">
                                <label for="">Date</label>
                                <input type="date" class="form-control" value="{{$notice->notice_date}}" name="notice_date" required>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{route('notice-edit',$notice->id)}}" class="btn btn-warning btn-xs align-content-center mr-1" style="float: right"><i class="fa fa-spinner" aria-hidden="true"></i> Refresh</a>
                    </div>
                </form>
            </div>
        </div>
