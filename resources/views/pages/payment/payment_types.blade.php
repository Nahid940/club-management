                        ...
                        @foreach ($types as $type)
                            ...
                            <tr @if($type->status==0) style="background-color: #ffb1ba"@endif>
                                ...
                                <td>
                                    ...
                                    @endif
                                    @if($type->status==1)
                                        <a data-id="{{$type->id}}" data-status="{{$type->status}}" class="status_change" style="cursor: pointer"><i class="fa fa-check-circle text-success  " title="Change to Inactive"></i></a>
                                    @elseif($type->status==0)
                                        <a data-id="{{$type->id}}" data-status="{{$type->status}}" class="status_change" style="cursor: pointer"><i class="fa fa-pause-circle text-danger" title="Change to Active"></i></a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
