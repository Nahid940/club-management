    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                    <h5> <i class="fa fa-times-circle text-danger" aria-hidden="true"></i> Postponed Membership List</h5>
                    <form action="">
                    ...
                    <a href="{{route('postponed-member-index')}}" class="btn btn-warning btn-xs mb-1 float-right mr-1"><i class="fa fa-spinner"></i> Refresh</a>
                    @if ($errors->any())
                    ...
                    <table id="example2" class="table table-bordered table-hover table-responsive-sm">
                        ...
                        <form action="{{route('approve-all-applications')}}" method="POST" id="approve_all">
                            ...
                            @foreach ($members as $member)
                                @php $i++; @endphp
                                <tr style="background-color: #fba5a5">
                                    <td>{{$i}}</td>
