            ...
            <div class="card-body">
                ...
                <form action="{{route('member-update',$member->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="member_type" name="member_type">
                                        ...
                                        <option value="1" {{ $member->member_type_dropdown == '1' ? 'selected' : ''}}>Donor Member</option>
                                        <option value="2" {{ $member->member_type_dropdown == '2' ? 'selected' : ''}}>Life Member</option>
                                        <option value="3" {{ $member->member_type_dropdown == '3' ? 'selected' : ''}}>NRB Member</option>
                                        <option value="4" {{ $member->member_type_dropdown == '4' ? 'selected' : ''}}>Genera Member</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-check">
                                        <input class="form-check-input" name="all_correspondence" type="checkbox" value="1" {{ $member->all_correspondence==1?"checked":"" }}>
                                        <label class="form-check-label">Present Address</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" name="all_correspondence" type="checkbox" value="2" {{ $member->all_correspondence==2?"checked":"" }}>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-check">
                                        <input class="form-check-input" name="should_be_sent_to" type="checkbox" value="1" {{ $member->should_be_sent_to==1?"checked":"" }}>
                    ...
                    <div class="" style="position: relative;width:100%;height: 50px;">
                        ...
                        <button type="submit" class="btn btn-success hidden" id=save style="position: absolute; right: 50%;"><i class="nav-icon fas fa-save"></i> Update</button>
                    </div>
                </form>
            </div>
            <!-- /.card-body -->
