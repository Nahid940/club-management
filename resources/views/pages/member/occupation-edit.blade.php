                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('purpose') is-invalid @enderror" value="{{ $occupation->occupation }}" id="occupation" name="occupation" placeholder="Occupation Title " required>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-body -->
